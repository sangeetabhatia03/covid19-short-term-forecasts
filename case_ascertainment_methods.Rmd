...
the estimate the new cases in the coming week by sampling from a gamma
distribution with mean and sdandard deviation equal estimated from
the number of observed cases in the last week. 

While this assume no growth or decline in the coming week, this baseline assumtpion
is justfiable as a null-hypthesis scenario which does not influence 
...
rely on observed reported cases up to the last day with available and 
estimated cases as described above.
