...
date_week_finishing <-  as.Date('19/04/2020',format = '%d/%m/%Y')
...
for (i in 1:N_geo){
  ...
  plot(summary_r$median$dates,summary_r$median[,i+1],lwd = 2,
       ...
       xaxt="n") 
  axis(1, at=as.Date(c('2020-03-01','2020-03-15','2020-04-01','2020-04-15'),format = '%Y-%m-%d'),
       labels = c('2020-03-01','2020-03-15','2020-04-01','2020-04-15'),las=1)
