...
700,000 cases of COVID-19 across the world, with more than 35,000
deaths [WHO Sitrep] . In this report, we use the reported number of deaths
...
22^nd^ March 2020, 14 countries/regions were included in the analysis based on these
thresholds. For the week beginning 29^th^ March 2020, the number of countries/regions 
included is 31.


* We forecast the number of potential eaths as the reporting of deaths
is likely to be more
reliable and stable over time than the reporting of cases. 
...
* USA with an estimated true epidemics size in this period of
  2,257,530 (95% CrI 1,395,862 - 2,173,824), and
* Spain with an estimated true epidemic size in this period of
1,944,557 (95% CrI 1,905,225 - 1,984,071).
...
#### Estimates of the Effective Reproduction Numbers
