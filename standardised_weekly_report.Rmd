...
* We forecast deaths as it likely that reporting of deaths in more
reliable than reporting of cases, and temporal trends in reporting of
deaths are also likely to be more stable than trends in reporting cases.
* Because we are forecasting deaths, latest estimates of
transmissibility reflect the epidemiological situation when those dying were infected.

A **secondary** objective of this report is to analyse case ascertainment per country. In this analysis, key assumptions are:
...
number last week (week starting [date]) was highest in:
...
Forecasts in previous weeks were good with [XX]% of observed numbers
of deaths per country included in our 95% CrI.

### Key results on case ascertainment

Case ascertainment based on the deaths in the previous 2 weeks  and 
reported cases in the 10 days prior to that period indicate that 
countries with lowest case ascertainment were:
...
COVID-19 deaths in countries with sustained local transmission. We aim 
to produce weekly forecasts every Monday. Multiple teams are involved, 
each producing weekly forecasts and a centralised team also produces 
an ensemble forecast.

We use reported deaths rather than reported cases, as the
ascertainment of deaths is likely to be much more stable over time
than the reporting of cases. The ascertainment of deaths is also 
likely to be much higher then for cases, as most cases will show mild 
(if any) symptoms.

As we forecasting deaths, the latest estimates of transmissibility reflect the epidemiological conditions when those dying were infected. Therefore, disadvantage in using death, is this delay between case reporting and death.

As well as forecasting, we also use reported death and past report cases (using a fix delay) to analyse the reporting trends per country. If the reporting of cases and death was perfect, as well as the delay between reporting and death fixed and known, the ratio of death to delayed cases would be exactly the Case Fatality Ratio (CFR).
