...
`r prettyNum(top2_deaths[["50%"]][1])` deaths 
 (95% CrI `r prettyNum(top2_deaths[["2.5%"]][1])` - 
 `r prettyNum(top2_deaths[["97.5%"]][1])`), and
 
* `r prettyNum(top2_deaths$country[2])` with an estimated median 
`r prettyNum(top2_deaths[["50%"]][2])` deaths
(95% CrI `r prettyNum(top2_deaths[["2.5%"]][2])` - `r prettyNum(top2_deaths[["97.5%"]][2])`).

and is lowest in:
  
* `r prettyNum(bottom2_deaths$country[1])` with an estimated median
`r prettyNum(bottom2_deaths[["50%"]][1])` deaths (95% CrI `r prettyNum(bottom2_deaths[["2.5%"]][1])` - `r prettyNum(bottom2_deaths[["97.5%"]][1])`), and
* `r bottom2_deaths$country[2]` with an estimated median 
`r prettyNum(bottom2_deaths[["50%"]][2])` deaths (95% CrI `r prettyNum(bottom2_deaths[["2.5%"]][2])` - `r prettyNum(bottom2_deaths[["97.5%"]][2])`).
