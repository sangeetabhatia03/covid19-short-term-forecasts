...
`r top2_deaths[["50%"]][1]` (95% CrI `r top2_deaths[["2.5%"]][1]` - `r top2_deaths[["97.5%"]][1]`), and
* `r top2_deaths$country[2]` with an estimated median deaths of 
`r top2_deaths[["50%"]][2]` (95% CrI `r top2_deaths[["2.5%"]][2]` - `r top2_deaths[["97.5%"]][2]`).

and is lowest in:
  
* `r bottom2_deaths$country[1]` with an estimated median deaths of 
`r bottom2_deaths[["50%"]][1]` (95% CrI `r bottom2_deaths[["2.5%"]][1]` - `r bottom2_deaths[["97.5%"]][1]`), and
* `r bottom2_deaths$country[2]` with an estimated median deaths of 
`r bottom2_deaths[["50%"]][2]` (95% CrI `r bottom2_deaths[["2.5%"]][2]` - `r bottom2_deaths[["97.5%"]][2]`).
